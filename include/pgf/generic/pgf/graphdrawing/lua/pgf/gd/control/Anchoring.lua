...
-- @release $Header: /cvsroot-fuse/pgf/pgf/generic/pgf/graphdrawing/lua/pgf/gd/control/Anchoring.lua,v 1.1 2012/11/27 17:24:24 tantau Exp $
...
declare {
  ...
  summary = [["
      ...
      be used for anchoring the whole graph.
 "]],
  documentation = [["
     When this option is
