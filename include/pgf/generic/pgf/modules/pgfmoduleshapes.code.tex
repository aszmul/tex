...
\ProvidesFileRCS $Header: /cvsroot-fuse/pgf/pgf/generic/pgf/modules/pgfmoduleshapes.code.tex,v 1.23 2012/11/20 23:41:04 tantau Exp $
...
\def\pgffakenode#1{%
  ...
  \expandafter\gdef\csname pgf@sh@pi@\pgf@temp\endcsname{\pgfpictureid}%
}
